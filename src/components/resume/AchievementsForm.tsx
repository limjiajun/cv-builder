...
import { PlusCircle, X, Edit, Save, XCircle, Calendar, Link } from "lucide-react";
...
const AchievementsForm: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (editId) {
      updateAchievement(editId, { title, description, date, url });
      setEditId(null);
    } else {
      addAchievement({ title, description, date, url });
    }
